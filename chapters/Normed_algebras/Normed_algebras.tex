...
\begin{document}
    ...
    \input{Normed_rings_and_modules/text.tex}
    \input{Convergent_and_restricted_power_series/text.tex}
    \input{Affinoid_algebras/text.tex}
    % \input{Finite_modules/text.tex}
