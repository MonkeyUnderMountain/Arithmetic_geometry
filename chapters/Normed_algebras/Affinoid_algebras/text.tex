...
\subsection{The first properties}
    ...
    \begin{example}\label{eg:normed_localization_as_affinoid_algebra}
        Let \(A\) be an affinoid \(\kk\)-algebra and \(f_i,g_i \in A\).
        Then the normed localization
        \[
            A\{(f_i/g_i)/r_i\}_{i=1}^n = A \otimes_{\kk\{ \underline{T} \}} \kk\{ \underline{T/r}, \underline{S} \}/(g_i T_i - f_i)_{i=1}^n 
        \]
        is again an affinoid \(\kk\)-algebra.
        \Yang{To be added.}
    \end{example}
...
% \subsection{Noetherian normalization theorem}
    ...
    \begin{theorem}\label{thm:noetherian_normalization_theorem}
        Let \(A\) be a strict affinoid \(\kk\)-algebra.
        Then there exists a finite injective admissible homomorphism
        \[
            \varphi: \kk\{ \underline{T} \} \hookrightarrow A
        \]
