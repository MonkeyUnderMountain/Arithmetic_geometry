...
\begin{document}
    ...
    \input{Classical_height_machine/text.tex}
    % \input{Hermitian_line_bundle_on_rings_of_integers/text.tex}
    % \input{Hermitian_line_bundles_on_projective_arithmetic_varieties/text.tex}
    \input{On_rings_of_integers/text.tex}
    \input{Hermitian_line_bundles/text.tex}
    \input{Arithmetic_Hilbert_Samuel/text.tex}
    \input{Arithmetic_fundamental_inequality/text.tex}
