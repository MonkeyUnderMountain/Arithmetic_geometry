...
\begin{document}
    ...
    \input{normed-rings-and-modules/text.tex}
    \section{Convergent and restricted power series (draft)}
    \input{convergent-and-restricted-power-series/text.tex}
    \section{Affinoid algebras (draft)}
    \input{affinoid-algebras/text.tex}
