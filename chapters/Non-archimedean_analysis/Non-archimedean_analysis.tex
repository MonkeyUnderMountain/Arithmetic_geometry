...
\begin{document}
    ...
    % \input{Valuation_fields/text.tex}
    % \input{Ultra-metric_spaces/text.tex}
    % \input{Residue_fields_and_reductions/text.tex}
    % \input{Finite_extensions/text.tex}
    % \input{Analytic_functions/text.tex}
    % \input{Example_p-adic_fields/text.tex}
