...
\subsection{Reduction map and kernel map}
    ...
    \begin{construction}\label{cons:reduction_map_from_spectrum_of_Banach_rings_to_spectrum_of_residue_ring}
        ...
        This gives rise to the reduction map from \(\scrM(R)\) to \(\Spec(\widetilde{R})\).
    \end{construction}
    
    
    There is a natural reduction map from the spectrum \(\scrM(R)\) to the spectrum \(\Spec(\widetilde{R} = R^\circ / R^{\circ \circ})\) of the residue ring \(\widetilde{R}\).
